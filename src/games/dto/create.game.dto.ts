...
export class CreateGameDto {
 ...
 @ApiProperty({
  ...
  @IsString()
  @ApiProperty({
    description: "Campo onde a entidade Game irá reservar a data de lançamento do jogo",
    example: "22/02/2022"
  })
  year: string
  ...
  @IsString()
  @ApiProperty({
    description: "Campo onde a entidade Game irá reservar a URL de um trailer do jogo",
